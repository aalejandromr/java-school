...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.lambdaschool.school")) // To be more specific with our package
    ...
    private ApiInfo apiEndPointsInfo()
    {
        return new ApiInfoBuilder().title("School Example")
                ...
                .contact(new Contact("Alejandro Mejia", "http://www.lambdaschool.com", "test@lambdaschool.com"))
